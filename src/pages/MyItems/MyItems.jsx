  ...
  <div className="max-w-6xl mx-auto p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl text-white space-y-6">
        ...
        <table className="min-w-full bg-white/5 backdrop-blur-md rounded-xl shadow-md">
          ...
          <tbody>
            {SelectedPost.map((item) => (
              <tr key={item.id} className="hover:bg-white/10 transition border-t border-white/10">
    ...
    {updateModalOpen && updatedPost && (
      <dialog open className="modal modal-bottom sm:modal-middle">
        <div className="modal-box bg-white/10 backdrop-blur-md rounded-2xl space-y-4 p-6 text-white">
          ...
          <form onSubmit={handleUpdateForm}>
            ...
            <div>
              <label className="block text-sm font-medium mb-1 text-teal-200">
                <i className="fas fa-exchange-alt mr-1 text-teal-300"></i>Post Type
              </label>
              <select
                name="postType"
            ...
            <div>
              <label className="block text-sm font-medium mb-1 text-teal-200">
                <i className="fas fa-info-circle mr-1 text-teal-300"></i>Description
              </label>
              <textarea
                name="description"
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1 text-teal-200">
                <i className="fas fa-layer-group mr-1 text-teal-300"></i>Category
              </label>
              <select
                name="category"
                required
            ...
            <div>
              <label className="block text-sm font-medium mb-1 text-teal-200">
                <i className="fas fa-map-marker-alt mr-1 text-teal-300"></i>Location
              </label>
              <input
                type="text"
                name="location"
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1 text-teal-200">
                <i className="fas fa-calendar-day mr-1 text-teal-300"></i>Date Lost or Found
              </label>
              <DatePicker
