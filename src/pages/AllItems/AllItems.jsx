      ...
      <div className="flex justify-center mb-10">
        <div className="relative w-full max-w-xl">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent transition"
          />
        </div>
      </div>
